...
6. 利用者向け文章・i18n: このスキルの「利用者向け文章・i18n の品質（必須）」の基準をここに全文転記し、対象の説明文・UI翻訳・ヘルプを確認すること
...
## 最優先の評価基準・観点・姿勢・出力形式
（差分レビュー版と同じ。CLAUDE.md/.claude/rules を尊重、観点1〜6（文章・i18n の品質基準を含む）、根拠と代替案を添える、深刻度で整理）
```
